...
import uz.com.oson.utils.extension.toJson
...
abstract class SharedPreference(context: Context, preferences: SharedPreferences? = null) {
    ...
    inner class strings(private val defValue: String = "") : ReadWriteProperty<Any, String> {
        ...
        override fun setValue(thisRef: Any, property: KProperty<*>, value: String) = pref.edit {
            Log.d("III", "setValue: shit $value shit2 ${property.name}")
