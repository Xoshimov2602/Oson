...
class LoginScreen : Screen {
    ...
    override fun Content() {
        ...
        LoginScreenContent(state = viewModel.state, eventDispatcher = viewModel::onEventDispatcher)
    }
}
...
fun LoginScreenContent(
    state: MutableState<LoginContract.UIState> = remember { mutableStateOf(LoginContract.UIState()) },
    ...
    Column(
        ...
        Column(
            ...
            Row {
                ...
                Checkbox(
                    ...
                    modifier = Modifier
                        .padding(start = 16.dp)
                        .clip(if (checked) RoundedCornerShape(3.dp) else RoundedCornerShape(16.dp))
        ...
        Button(
            enabled = text.length == 9 && password.length >= 4,
            onClick = {
                eventDispatcher(
                    LoginContract.Intent.OnClickNext(
                        phone = "+998$text",
                        password = password
                    )
                )
